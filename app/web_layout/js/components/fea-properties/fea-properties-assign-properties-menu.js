class FeaPropertiesAssignPropertiesMenu extends HTMLElement {
    ...
    connectedCallback() {
        ...
        document.querySelector("fea-app").dispatchEvent(new CustomEvent("enableAssignPropertiesMenu"));
    }

    disconnectedCallback() {
        document.querySelector("fea-app").dispatchEvent(new CustomEvent("disableAssignPropertiesMenu"));
    }
