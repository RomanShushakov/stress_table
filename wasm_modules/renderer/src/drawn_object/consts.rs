...
pub const DRAWN_CONCENTRATED_LOAD_OBJECTS_LINE_LENGTH: f32 = 0.04; // line length
pub const DRAWN_CONCENTRATED_LOAD_OBJECTS_CAPS_HEIGHT: f32 = 0.0085; // arrow length
pub const DRAWN_CONCENTRATED_LOAD_OBJECTS_CAPS_WIDTH: f32 = 0.00325; // half of arrow width
pub const DRAWN_CONCENTRATED_LOAD_OBJECTS_CAPS_BASE_POINTS_NUMBER: u32 = 12; // the number of points in cone circular base
pub const DRAWN_CONCENTRATED_LOAD_OBJECTS_COLOR: [f32; 4] = [0.956, 0.643, 0.376, 1.0]; // SandyBrown
