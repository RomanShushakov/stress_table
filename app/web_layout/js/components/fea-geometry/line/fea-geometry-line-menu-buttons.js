    ...
    constructor() {
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .geometry-add-line-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .geometry-add-line-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .geometry-add-line-menu-button:hover .geometry-add-line-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .geometry-add-line-menu-button-icon {
                    color: #8bbee4;
                }

                .active .geometry-add-line-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .geometry-add-line-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .geometry-add-line-menu-button-icon-content {
                ...
                .geometry-update-line-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .geometry-update-line-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .geometry-update-line-menu-button:hover .geometry-update-line-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .geometry-update-line-menu-button-icon {
                    color: #8bbee4;
                }

                .active .geometry-update-line-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .geometry-update-line-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .geometry-update-line-menu-button-icon-content {
                    border-bottom: 0.15rem solid #72C5FF;
                }
                ...
                .geometry-delete-line-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .geometry-delete-line-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .geometry-delete-line-menu-button:hover .geometry-delete-line-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .geometry-delete-line-menu-button-icon {
                    color: #8bbee4;
                }

                .active .geometry-delete-line-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .geometry-delete-line-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .geometry-delete-line-menu-button-icon-content {
                    border-bottom: 0.15rem solid #72C5FF;
                }
            </style>
            ...
            <div class=wrapper>
                <div class="geometry-line-menu-buttons-content">
                    ...
                    <button class="geometry-add-line-menu-button">
                        <div class="geometry-add-line-menu-button-icon-content">
                            <svg class="geometry-add-line-menu-button-icon" width="35" height="35" viewBox="0 0 35 35" fill="none" 
                    ...
                    <button class="geometry-update-line-menu-button">
                        <div class="geometry-update-line-menu-button-icon-content">
                            <svg class="geometry-update-line-menu-button-icon" width="36" height="35" viewBox="0 0 36 35" fill="none" 
                                xmlns="http://www.w3.org/2000/svg"
                            >
                    ...
                    <button class="geometry-delete-line-menu-button">
                        <div class="geometry-delete-line-menu-button-icon-content">
                            <svg class="geometry-delete-line-menu-button-icon" width="35" height="35" viewBox="0 0 35 35" fill="none" 
                                xmlns="http://www.w3.org/2000/svg"
                            >
