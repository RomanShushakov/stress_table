    ...
    constructor() {
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .section-add-truss-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-add-truss-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-add-truss-menu-button:hover .section-add-truss-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .section-add-truss-menu-button-icon {
                    color: #8bbee4;
                }

                .active .section-add-truss-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .section-add-truss-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .section-add-truss-menu-button-icon-content {
                ...
                .section-update-truss-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-update-truss-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-update-truss-menu-button:hover .section-update-truss-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .section-update-truss-menu-button-icon {
                    color: #8bbee4;
                }

                .active .section-update-truss-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .section-update-truss-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .section-update-truss-menu-button-icon-content {
                    border-bottom: 0.15rem solid #72C5FF;
                }
                ...
                .section-delete-truss-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-delete-truss-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-delete-truss-menu-button:hover .section-delete-truss-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .section-delete-truss-menu-button-icon {
                    color: #8bbee4;
                }

                .active .section-delete-truss-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .section-delete-truss-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .section-delete-truss-menu-button-icon-content {
                    border-bottom: 0.15rem solid #72C5FF;
                }
            </style>
            ...
            <div class=wrapper>
                <div class="section-truss-menu-buttons-content">
                    ...
                    <button class="section-add-truss-menu-button">
                        <div class="section-add-truss-menu-button-icon-content">
                    ...
                    <button class="section-update-truss-menu-button">
                        <div class="section-update-truss-menu-button-icon-content">
                    ...
                    <button class="section-delete-truss-menu-button">
                        <div class="section-delete-truss-menu-button-icon-content">
