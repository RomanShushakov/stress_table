class FeaMaterialAddMaterialMenu extends HTMLElement {
    constructor() {
        ...
        this.shadowRoot.querySelector(".young-modulus").addEventListener("click", () => {
            const youngModulus = this.shadowRoot.querySelector(".young-modulus");
            this.dropHighlight(youngModulus);
            this.shadowRoot.querySelector(".analysis-info-message").innerHTML = "";
        });

        this.shadowRoot.querySelector(".poisson-ratio").addEventListener("click", () => {
            const poissonRatio = this.shadowRoot.querySelector(".poisson-ratio");
            this.dropHighlight(poissonRatio);
            this.shadowRoot.querySelector(".analysis-info-message").innerHTML = "";
        });
    }
