    ...
    constructor() {
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .section-add-beam-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-add-beam-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-add-beam-menu-button:hover .section-add-beam-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .section-add-beam-menu-button-icon {
                    color: #8bbee4;
                }

                .active .section-add-beam-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .section-add-beam-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .section-add-beam-menu-button-icon-content {
                ...
                .section-update-beam-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-update-beam-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-update-beam-menu-button:hover .section-update-beam-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .section-update-beam-menu-button-icon {
                    color: #8bbee4;
                }

                .active .section-update-beam-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .section-update-beam-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .section-update-beam-menu-button-icon-content {
                    border-bottom: 0.15rem solid #72C5FF;
                }
                ...
                .section-delete-beam-menu-button-icon-content {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-delete-beam-menu-button-icon {
                    margin: 0rem;
                    padding: 0rem;
                    width: 1.5rem;
                    height: 1.5rem;
                ...
                .section-delete-beam-menu-button:hover .section-delete-beam-menu-button-icon {
                    color: #d1d2d7;
                }

                .active:hover .section-delete-beam-menu-button-icon {
                    color: #8bbee4;
                }

                .active .section-delete-beam-menu-button-icon {
                    color: #72C5FF;
                }

                .active:hover .section-delete-beam-menu-button-icon-content {
                    border-bottom: 0.15rem solid #8bbee4;
                }

                .active .section-delete-beam-menu-button-icon-content {
                    border-bottom: 0.15rem solid #72C5FF;
                }
            </style>
            ...
            <div class=wrapper>
                <div class="section-beam-menu-buttons-content">
                    ...
                    <button class="section-add-beam-menu-button">
                        <div class="section-add-beam-menu-button-icon-content">
                            <svg class="section-add-beam-menu-button-icon" width="35" height="35" viewBox="0 0 35 35" fill="none" 
                                xmlns="http://www.w3.org/2000/svg"
                            >  
                                <title>Add beam section</title>
                    ...
                    <button class="section-update-beam-menu-button">
                        <div class="section-update-beam-menu-button-icon-content">
                            <svg class="section-update-beam-menu-button-icon" width="36" height="35" viewBox="0 0 36 35" fill="none" 
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <title>Update beam section</title>
                                <g stroke="currentColor">
                    ...
                    <button class="section-delete-beam-menu-button">
                        <div class="section-delete-beam-menu-button-icon-content">
                            <svg class="section-delete-beam-menu-button-icon" width="35" height="35" viewBox="0 0 35 35" fill="none" 
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <title>Delete beam section</title>
                                <g stroke="currentColor">
