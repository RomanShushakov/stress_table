class FeaSectionUpdateBeamMenu extends HTMLElement {
    ...
    defineBeamSectionNameOptions() {
        ...
        if (this.props.beamSections.length > 0) {
            ...
            this.shadowRoot.querySelector(".area2").value = this.props.beamSections[0].area2;
            this.shadowRoot.querySelector(".I11_2").value = this.props.beamSections[0].I11_2;
            this.shadowRoot.querySelector(".I22_2").value = this.props.beamSections[0].I22_2;
            this.shadowRoot.querySelector(".I12_2").value = this.props.beamSections[0].I12_2;
            this.shadowRoot.querySelector(".It_2").value = this.props.beamSections[0].It_2;
        } else {
    ...
    updateBeamSectionData() {
        ...
        this.shadowRoot.querySelector(".area2").value = beamSectionInProps.area2;
        this.shadowRoot.querySelector(".I11_2").value = beamSectionInProps.I11_2;
        this.shadowRoot.querySelector(".I22_2").value = beamSectionInProps.I22_2;
        this.shadowRoot.querySelector(".I12_2").value = beamSectionInProps.I12_2;
        this.shadowRoot.querySelector(".It_2").value = beamSectionInProps.It_2;
        this.shadowRoot.querySelector(".analysis-info-message").innerHTML = "";
    }
    ...
    updateBeamSection() {
        ...
        const inputtedI11_2Field = this.shadowRoot.querySelector(".I11_2");

        const inputtedI22_2Field = this.shadowRoot.querySelector(".I22_2");

        const inputtedI12_2Field = this.shadowRoot.querySelector(".I12_2");

        const inputtedIt_2Field = this.shadowRoot.querySelector(".It_2");
        ...
        const beamSectionDataInProps = this.props.beamSections
            .find(beamSection => beamSection.area == inputtedAreaField.value && 
                ...
                (beamSection.area2 == inputtedArea2Field.value || 
                    (beamSection.area2 === null && inputtedArea2Field.value === "")) &&
                (beamSection.I11_2 == inputtedI11_2Field.value || 
                    (beamSection.I11_2 === null && inputtedI11_2Field.value === "")) &&
                (beamSection.I22_2 == inputtedI22_2Field.value || 
                    (beamSection.I22_2 === null && inputtedI22_2Field.value === "")) &&
                (beamSection.I12_2 == inputtedI12_2Field.value || 
                    (beamSection.I12_2 === null && inputtedI12_2Field.value === "")) &&
                (beamSection.It_2 == inputtedIt_2Field.value || 
                    (beamSection.It_2 === null && inputtedIt_2Field.value === "")));
        ...
        const message = { "update_beam_section": {
            ...
            "old_beam_section_values": { 
                ...
                "area2": oldBeamSectionValues.area2,
                "I11_2":  oldBeamSectionValues.I11_2,
                "I22_2":  oldBeamSectionValues.I22_2,
                "I12_2":  oldBeamSectionValues.I12_2, 
                "It_2":  oldBeamSectionValues.It_2 },
            "new_beam_section_values": { 
                ...
                "I11_2": inputtedI11_2Field.value,
                "I22_2": inputtedI22_2Field.value,
                "I12_2": inputtedI12_2Field.value,
                "It_2": inputtedIt_2Field.value }
        }};
