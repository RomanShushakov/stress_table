...
pub const DRAWN_CONCENTRATED_LOAD_OBJECTS_LINE_LENGTH: f32 = 0.07; // line length
pub const DRAWN_CONCENTRATED_LOAD_OBJECTS_CAPS_HEIGHT: f32 = 0.015; // arrow length
pub const DRAWN_CONCENTRATED_LOAD_OBJECTS_CAPS_WIDTH: f32 = 0.007; // half of arrow width
